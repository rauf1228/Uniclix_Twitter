        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <UpgradeAlert isOpen={this.state.trialLimit} cancelBtn="Skip now" text="You have exceeded your daily follow/unfollow limit." goBack={false} redirectBack="/twitter-booster/followers" setForbidden={this.setForbidden} />

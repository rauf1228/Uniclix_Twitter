                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 14px; color: #555555;">
                                            ...
                                            <p></p>
                                            <p style="font-size: 12px; line-height: 16px; margin: 0;"><span style="font-size: 14px;">You just took the first step towards growing your Twitter account, congrats. Whether you are interested in growing your following or increase engagement with existing followers, Uniclix can help. Now it's all up to you. </span></p>
                                            <p></p>
                                            <p style="font-size: 12px; line-height: 16px; margin: 0;"><br /><span style="font-size: 13px;">We have provided a few first steps below to help get you started.</span></p>
                                            <p></p>
                                            <p style="font-size: 12px; line-height: 16px; margin: 0;"><br /><span style="font-size: 20px; color: #5a86e8;"><strong>Step 1: Configure Direct Messaging</strong></span></p>
                                            <p></p>

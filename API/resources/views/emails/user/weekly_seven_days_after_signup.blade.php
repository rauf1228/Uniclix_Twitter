...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        .item-row .profile-info .user-info img {
            width: 45px;
            height: 45px;
            margin-right: 15px;
        }
        .item-row .profile-info {
            display: flex;
            flex-direction: row;
        ...
        .item-row .profile-info .user-info {
            width: 150px;
            display: flex;
            align-items: center;
        }
        ...
        .item-row .profile-username {
            color: #909090;
            font-weight: normal;
            font-size: 12px;
        }
        .item-row .profile-title {
            font-size: 12px;
        ...
        .item-row .profile-info .stats-info {
            display: flex;
            margin: 0;
        ...
        .item-row .profile-info .stats-info li {
            margin-right: 15px;
            text-align: center;
        }
        .item-row .profile-info .stats-info .stat-count {
            font-size: 13px;
            font-weight: bold;
        }
        .item-row .profile-info .stats-info .stat-name {
            font-size: 12px;
            color: #909090;
        }
    </style>
                                                ...
                                                <table style="width:100%; background: #f5f7fb;">
                                                    ...
                                                    @foreach($items as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p style="margin: 5px; font-weight: bold; text-transform: capitalize; font-size: 13px; color: #363636; max-width: 200px !important; height: 15px;"><strong>{{$item->name}}  </strong></p>
                                                                <p style="margin: 5px; color: #909090; font-weight: normal; font-size: 12px; max-width: 200px !important; height: 15px;">@ {{$item->screen_name}}</p>
